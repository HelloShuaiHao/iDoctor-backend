...
echo "生成 Nginx 配置文件..."
envsubst '${NGINX_PORT} ${NGINX_SERVER_NAME} ${AUTH_SERVICE_HOST} ${AUTH_SERVICE_PORT} ${PAYMENT_SERVICE_HOST} ${PAYMENT_SERVICE_PORT} ${IDOCTOR_API_HOST} ${IDOCTOR_API_PORT} ${SAM2_SERVICE_HOST} ${SAM2_SERVICE_PORT} ${SAM2_NEW_FRONTEND_HOST} ${SAM2_NEW_FRONTEND_PORT} ${SAM2_NEW_BACKEND_HOST} ${SAM2_NEW_BACKEND_PORT} ${STATIC_ROOT}' \
