...
export SAM2_NEW_FRONTEND_HOST=${SAM2_NEW_FRONTEND_HOST:-${IDOCTOR_API_HOST}}
export SAM2_NEW_FRONTEND_PORT=${SAM2_NEW_FRONTEND_PORT:-7262}
export SAM2_NEW_BACKEND_HOST=${SAM2_NEW_BACKEND_HOST:-${IDOCTOR_API_HOST}}
export SAM2_NEW_BACKEND_PORT=${SAM2_NEW_BACKEND_PORT:-7263}
export TRAINING_API_HOST=${TRAINING_API_HOST:-${IDOCTOR_API_HOST}}
export TRAINING_API_PORT=${TRAINING_API_PORT:-7264}
...
echo "  SAM2前端: ${SAM2_NEW_FRONTEND_HOST}:${SAM2_NEW_FRONTEND_PORT}"
echo "  SAM2后端: ${SAM2_NEW_BACKEND_HOST}:${SAM2_NEW_BACKEND_PORT}"
echo "  Training API: ${TRAINING_API_HOST}:${TRAINING_API_PORT}"
echo "  静态文件: ${STATIC_ROOT}"
echo "==================================="

# 使用 envsubst 替换配置文件中的环境变量
echo "生成 Nginx 配置文件..."
envsubst '${NGINX_PORT} ${NGINX_SERVER_NAME} ${AUTH_SERVICE_HOST} ${AUTH_SERVICE_PORT} ${PAYMENT_SERVICE_HOST} ${PAYMENT_SERVICE_PORT} ${IDOCTOR_API_HOST} ${IDOCTOR_API_PORT} ${SAM2_SERVICE_HOST} ${SAM2_SERVICE_PORT} ${SAM2_NEW_FRONTEND_HOST} ${SAM2_NEW_FRONTEND_PORT} ${SAM2_NEW_BACKEND_HOST} ${SAM2_NEW_BACKEND_PORT} ${TRAINING_API_HOST} ${TRAINING_API_PORT} ${STATIC_ROOT}' \
